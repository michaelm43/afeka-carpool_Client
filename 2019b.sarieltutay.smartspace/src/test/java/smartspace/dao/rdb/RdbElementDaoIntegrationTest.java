...
public class RdbElementDaoIntegrationTest {
	...
	public void testCreateUpdateAndRead() throws Exception {
		...
		ElementEntity newElement = new ElementEntity(new Location(),name, type, new Date(), false, smartspace, email, null);
		...
		ElementEntity update = new ElementEntity(new Location(),name, type, new Date(), false, smartspace, email, null);
	...
	public void testDeleteNonexistentElement() throws Exception {		
		...
		newElement.setKey("sarielshaymichael=1");
		newElement= this.elementDao.create(newElement);
		ElementEntity newElementTodelete = new ElementEntity(new Location(),name, type, new Date(), false, smartspace, email, null);
